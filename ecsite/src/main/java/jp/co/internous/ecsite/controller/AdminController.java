...
public class AdminController {
	...
	@RequestMapping("/accountMst")
	public String accountMst(LoginForm form, Model m) {
		m.addAttribute("userName", form.getUserName());
		m.addAttribute("password", form.getPassword());
	...
	public String addAccount(AccountForm accountForm,LoginForm loginForm, Model m) {
		m.addAttribute("userName", loginForm.getUserName());
		m.addAttribute("password", loginForm.getPassword());
		
		User user=new User();
		user.setFullName(accountForm.getFullName());
